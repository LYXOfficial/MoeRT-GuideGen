  ...
  return (
    ...
    >
      ...
      <g id="b">
        ...
        />
        <circle fill="#00ade9" cx="43" cy="73" r="11.12" />
        <path
          fill="#D7A3AB"
        ...
        />
        <circle fill="#D7A3AB" cx="125" cy="73" r="11.12" />
        <path
          fill="#6CC24A"
        ...
        />
        <circle fill="#6CC24A" cx="82" cy="146" r="6" />
        <g mask="url(#c)">
          <circle
            fill="none"
            stroke="#6CC24A"
        ...
        />
        <circle fill="#6CC24A" cx="192" cy="101" r="8.5" />
      </g>
    </svg>
  );
};

export default ThirdToiletColor;
