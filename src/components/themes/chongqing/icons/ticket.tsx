const Ticket: React.FC<React.SVGProps<SVGSVGElement> & { rotation?: number; background?: string; foreground?: string }> = ({ rotation = 0, background = '#fff', foreground = 'currentColor', style, ...props }) => {
  ...
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" style={mergedStyle} {...props}>
      ...
      <text fontFamily="MicrosoftYaHeiUI-Bold, 'Microsoft YaHei UI, sans-serif'" fontSize={54} fontWeight={700} transform="translate(39 221.21)" fill={foreground}>
        ￥
      </text>
    </svg>
  )
